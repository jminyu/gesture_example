...
#define WM_USER_UPDATE_RIGHTCOORD		WM_USER+3
#define WM_USER_UPDATE_LEFTCOORD		WM_USER+4
#define WM_USER_UPDATE_HEADCOORD		WM_USER+5
#define WM_USER_UPDATE_LEFTGESTURE		WM_USER+6
#define WM_USER_UPDATE_RIGHTGESTURE		WM_USER+7
